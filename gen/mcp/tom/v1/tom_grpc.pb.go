...
const (
	...
	TomService_TestValidation_FullMethodName        = "/mcp.tom.v1.TomService/TestValidation"
)
...
func (c *tomServiceClient) TestValidation(ctx context.Context, in *TestValidationRequest, opts ...grpc.CallOption) (*TestValidationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestValidationResponse)
	err := c.cc.Invoke(ctx, TomService_TestValidation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTomServiceServer) TestValidation(context.Context, *TestValidationRequest) (*TestValidationResponse, error) {
...
func _TomService_TestValidation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestValidationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TomServiceServer).TestValidation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TomService_TestValidation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TomServiceServer).TestValidation(ctx, req.(*TestValidationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TomService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TomService_TestValidation_Handler,
		},
	},
