...
type TomServiceServer interface {
	CreateItem(ctx context.Context, req *mcp.CreateItemRequest) (*mcp.CreateItemResponse, error)
	GetItem(ctx context.Context, req *mcp.GetItemRequest) (*mcp.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *mcp.ProcessWellKnownTypesRequest) (*mcp.ProcessWellKnownTypesResponse, error)
}
...
func RegisterTomServiceHandler(s *mcpserver.MCPServer, srv TomServiceServer, opts ...runtime.Option) {
	...
	s.AddTool(ProcessWellKnownTypesTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req mcp.ProcessWellKnownTypesRequest
...
type TomServiceClient interface {
	CreateItem(ctx context.Context, req *mcp.CreateItemRequest, opts ...grpc.CallOption) (*mcp.CreateItemResponse, error)
	GetItem(ctx context.Context, req *mcp.GetItemRequest, opts ...grpc.CallOption) (*mcp.GetItemResponse, error)
	ProcessWellKnownTypes(ctx context.Context, req *mcp.ProcessWellKnownTypesRequest, opts ...grpc.CallOption) (*mcp.ProcessWellKnownTypesResponse, error)
}

// ConnectTomServiceClient is compatible with the connectrpc-go client interface.
type ConnectTomServiceClient interface {
	CreateItem(ctx context.Context, req *connect.Request[mcp.CreateItemRequest]) (*connect.Response[mcp.CreateItemResponse], error)
	GetItem(ctx context.Context, req *connect.Request[mcp.GetItemRequest]) (*connect.Response[mcp.GetItemResponse], error)
	ProcessWellKnownTypes(ctx context.Context, req *connect.Request[mcp.ProcessWellKnownTypesRequest]) (*connect.Response[mcp.ProcessWellKnownTypesResponse], error)
}
