...
import (
	v1 "github.com/bufbuild/buf-examples/gen/mcp/tom/v1"
)
...
type TomServiceServer interface {
	...
	TestValidation(ctx context.Context, req *v1.TestValidationRequest) (*v1.TestValidationResponse, error)
}
...
func RegisterTomServiceHandler(s *mcpserver.MCPServer, srv TomServiceServer, opts ...runtime.Option) {
	...
	TestValidationTool := TomService_TestValidationTool
	// Add extra properties to schema if configured
	if len(config.ExtraProperties) > 0 {
	...
	s.AddTool(TestValidationTool, func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		var req v1.TestValidationRequest
...
func RegisterTomServiceHandlerOpenAI(s *mcpserver.MCPServer, srv TomServiceServer, opts ...runtime.Option) {
	...
	TestValidationToolOpenAI := TomService_TestValidationToolOpenAI
	// Add extra properties to schema if configured
	if len(config.ExtraProperties) > 0 {
...
type TomServiceClient interface {
	...
	TestValidation(ctx context.Context, req *v1.TestValidationRequest, opts ...grpc.CallOption) (*v1.TestValidationResponse, error)
}
...
type ConnectTomServiceClient interface {
	...
	TestValidation(ctx context.Context, req *connect.Request[v1.TestValidationRequest]) (*connect.Response[v1.TestValidationResponse], error)
}
