...
const file_mcp_tom_v1_tom_proto_rawDesc = "" +
	...
	"\x15ProcessWellKnownTypes\x12(.mcp.tom.v1.ProcessWellKnownTypesRequest\x1a).mcp.tom.v1.ProcessWellKnownTypesResponseB\x9a\x01\n" +
	"\x0ecom.mcp.tom.v1B\bTomProtoP\x01Z4github.com/tomschdev/mcp/grpc/proto/pb/go/mcp/tom/v1\xa2\x02\x03MTX\xaa\x02\n" +
	"Mcp.Tom.V1\xca\x02\n" +
